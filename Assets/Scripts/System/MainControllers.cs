...
public class MineControllers : IExecute, IInitialization, ILateExecute, ICleanup, IFixedExecute, IAwake
{
    ...
    internal MineControllers Add(IController controller)
    {
